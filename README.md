...
A few parameters can be passed to this endpoint:
...
* make some performance tests to find out what's the best numbers for thoses (i've never done that before though)
